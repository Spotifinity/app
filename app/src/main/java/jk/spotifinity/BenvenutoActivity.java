	...
	private void initialize(Bundle _savedInstanceState) {
		...
		materialbutton1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				FileUtil.makeDir("storage/emulated/0/spotifinity");
				FileUtil.writeFile("storage/emulated/0/spotifinity/skipWelcome", "");
				FileUtil.writeFile("storage/emulated/0/spotifinity/downloaded.txt", "Nessuna");
